...
class LocalLocationDataSource @Inject constructor(
    ...
    override suspend fun getLocationAll(): List<LocationEntity> = dao.getLocationAll()
    override suspend fun getLocation(id: Int): LocationEntity = dao.getLocationById(id)
    override suspend fun insertLocation(location: LocationEntity) = dao.insertLocation(location)
